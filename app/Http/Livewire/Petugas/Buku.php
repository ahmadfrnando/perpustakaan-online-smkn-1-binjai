...
class Buku extends Component
{
    ...
    {
        // $this->rak = Rak::all();
        $this->rak = Rak::where('kategori_id', (int)$this->kategori_id)->get();
    }
    ...
    {
        if ($this->search) {
            $buku = ModelsBuku::latest()->where('judul', 'like', '%' . $this->search . '%')->paginate(15);
        } else {
            $buku = ModelsBuku::latest()->paginate(15);
        }
